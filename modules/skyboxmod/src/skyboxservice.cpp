    ...
    */
    ...
    if( m_texturemirrorpass )
    {
        ...
        for( long i = 0; i < 6; i++ )
        {
            ...
            rss.AddRenderStateIn( DrawSpace::Core::RenderState( DrawSpace::Core::RenderState::SETCULLING, "ccw" ) );
            ...
            entry.skybox->GetNodeFromPass( m_texturemirrorpass, i )->GetFx()->SetRenderStates( rss );
            /*

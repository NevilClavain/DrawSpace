...
public:
    ...
    /// donnees globales, pas specifiquement li�e au nodes, mais je le met l� car c'est plus simple
    /// que de remettre en place un autre key bindings ;-)
    //  comme ces donn�es sont globales � l'instance planete, ces valeurs seront identiques quelquesoit le nodes LOD dependant de l'instance planete

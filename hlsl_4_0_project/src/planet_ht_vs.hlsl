...
// z -> temperature_alt_dec : en degres centigrades; taux de decrementation de temperature au fur et a mesure de l'augmentation de l'altitude -> nombre de degres perdus tout les 1000 m�tres
// w -> beach_lim, en m�tres

#define v_thparams2                 43
// x -> lim polar : en latitude "normalis�e" : 0.0 = pole, 1.0 = equateur
// y -> lim tropical : en latitude "normalis�e" : 0.0 = pole, 1.0 = equateur
...
VS_OUTPUT vs_main(VS_INPUT Input)
{
    ...
    */
    ...
    // color_temp (temperature) �lev�e
    //      -> vertex = 0.0 : humidit� �lev�e
    //      -> vertex = humidity_alt_max : humidit� faible
    // 
    // color_temp (temperature) basse
    //      -> vertex = 0.0 : humidit� faible
    //      -> vertex = humidity_alt_max : humidit� �lev�e

    // seuil humidity_alt_max �lev� -> l'humidit� se "repandra" plus facilement

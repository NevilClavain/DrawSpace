...
class ??class_name????extension_type??AspectImpl;
// fwd decls

class LuaClass_??class_name????extension_type??
{
private:
...
public:
    ...
    static const Luna<LuaClass_??class_name????extension_type??>::RegType methods[];

...
{
    //BasicSceneScriptEditFrame* frame = new BasicSceneScriptEditFrame( this, "Mouse move", &BasicSceneMainFrame::GetInstance()->m_mousemove_script, &m_mousemove_script_enabled );
    //frame->Show();

...
class LuaClass_FPSMovementTransform : public DrawSpace::Interface::AspectImplementations::TransformAspectImpl
{
private:
    DrawSpace::Aspect::TransformAspect*     	m_entity_transform_aspect { nullptr };

public:
    LuaClass_FPSMovementTransform( lua_State* p_L );
	~LuaClass_FPSMovementTransform( void );

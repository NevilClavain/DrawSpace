...
VS_OUTPUT vs_main( VS_INPUT Input )
{
	...
	{	
        ...
        v_alt = ComputeVertexHeight(TexturePlanetMap, v_position2, global_uv, landscape_control.x, landscape_control.y, landscape_control.z, seeds.x, seeds.y, landscape_control.w);

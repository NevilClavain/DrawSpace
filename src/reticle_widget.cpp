...
ReticleWidget::ReticleWidget( const dsstring& p_name, long p_virtual_width, long p_virtual_height, DrawSpace::Core::SceneNodeGraph* p_scenegraph, Widget* p_parentwidget ) :
...
dsreal ReticleWidget::GetLastDistance( void )
{
    return m_distance;
}

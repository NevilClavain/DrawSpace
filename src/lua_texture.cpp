...
int LuaTexture::Lua_InstanciateObject( lua_State* p_L )
{
    ...
    bool render_target = (bool)luaL_checkinteger( p_L, 3 );
    unsigned long render_target_width = (unsigned long)luaL_checkinteger( p_L, 4 );
    unsigned long render_target_height = (unsigned long)luaL_checkinteger( p_L, 5 );

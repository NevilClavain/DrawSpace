...
#define _DRAWSPACE_DELETE_( __ptr__ ) delete __ptr__; DrawSpace::Utils::MemAlloc::GetInstance()->Unregister( __ptr__ )
#define _DRAWSPACE_DELETE_N_( __ptr__ ) delete[] __ptr__; DrawSpace::Utils::MemAlloc::GetInstance()->Unregister( __ptr__ )

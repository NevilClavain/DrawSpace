...
BodyTransformAspectImpl::BodyTransformAspectImpl( btDefaultMotionState** p_motionState, Matrix* p_collider_mat ) :
m_motionState( p_motionState ),
m_collider_mat( p_collider_mat )
{
}

void BodyTransformAspectImpl::SetColliderMode( bool p_collider_mode )
{
    m_collider_mode = p_collider_mode;
}
